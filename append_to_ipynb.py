...
nb_path = "/data/liuj35/quan_fuselage/analyze_constraint_continuous_regret.ipynb"
...
# Split by newline and append \n to reconstruct lines for ipynb
code_lines = [line + "\n" for line in code_content.split("\n")]
# Remove the trailing newline on the last line just slightly cleaner
if code_lines[-1] == "\n":
    code_lines[-1] = ""
